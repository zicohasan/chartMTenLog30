package com.qmul.deni.chartmtenlog;
...
import com.qmul.deni.chartmtenlog.custom.MyMarkerView;
...
import com.qmul.deni.chartmtenlog.adapter.RecyclerViewAdapter;
import com.qmul.deni.chartmtenlog.api.RegisterAPI;
import com.qmul.deni.chartmtenlog.model.Charts;
import com.qmul.deni.chartmtenlog.model.Value;
import com.github.mikephil.charting.charts.LineChart;
import com.github.mikephil.charting.components.YAxis;
import com.github.mikephil.charting.data.Entry;
import com.github.mikephil.charting.data.LineData;
...
//            mySound.play(raygunID, 1, 1, 1, 0, (0.4f));
            ...
            // kalibrasi bunyi pertama
            mySound.play(raygunID, 1, 1, 1, 0, 1f);

            Log.i("££counter01-:", String.valueOf(counter-0.099)+"&"+String.valueOf(130.81));
            try
            {
                Thread.sleep(500);
            }
            ...
            while(YMax * counter <= YEstimate) {
                if (counter <= 0.21) {
                        main =((float) (Math.pow(2, (counter * 20 * 3/ 12))));
//                    mySound.play(raygunID, 1, 1, 1, 0, ((float) 1f));
                    mySound.play(raygunID, 1, 1, 1, 0, main);

                    Log.i("££counter <= 0.2:", String.valueOf(counter) + "&" + String.valueOf(130.81*((Math.pow(2, (counter * 20 * 3/ 12))))));
                    counter += 0.1;
                    try {
                        Thread.sleep(500);
                    } catch (InterruptedException ex) {
                ...
                } else if (counter > 0.21 && counter <= 0.41) {
//                    mySound.play(raygunID, 1, 1, 1, 0, ((float)261.62));
                    main = ((float) (Math.pow(2, (((counter + (counter - 0.1)) * 10 * 3/ 12)-1))));

                    mySound.play(eID, 1, 1, 1, 0, main);

                    Log.i("££counter <= 0.4:", String.valueOf(counter) + "&" + String.valueOf(261.62*main));
                ...
                else if (counter > 0.41 && counter <= 0.61) {
                    main = ((float) (Math.pow(2, ((((counter + (counter - 0.1)) * 10 * 3-21)/ 12)))));
                    mySound.play(aID, 1, 1, 1, 0, main);
                    Log.i("££counter <= 6 :", String.valueOf(counter) + "&" + String.valueOf(440*main));
                    counter += 0.1;
                    try {
                        Thread.sleep(500);
                    } catch (InterruptedException ex) {
                ...
                } else if (counter > 0.61 && counter <= 0.91) {
                    main =((float) (Math.pow(2, ((((counter + (counter - 0.2)) * 10 * 3-33)/ 12)))));

                    mySound.play(a5ID, 1, 1, 1, 0, main);
                    Log.i("££counter <=9:", String.valueOf(counter) + "&" + String.valueOf(880*(Math.pow(2, ((((counter + (counter - 0.2)) * 10 * 3-33)/ 12))))));
                    counter += 0.1;
                    try {
                        Thread.sleep(500);
                    } catch (InterruptedException ex) {
                ...
                } else if (counter > 0.91 && counter <= 1) {
                    main = ((float) (Math.pow(2, ((((counter + (counter - 0.3)) * 10 * 3-48)/ 12)))));

                    mySound.play(bID, 1, 1, 1, 0, main);
                    Log.i("££counter <=1:", String.valueOf(counter) + "&" + String.valueOf(2093*(Math.pow(2, ((((counter + (counter - 0.3)) * 10 * 3-48)/ 12))))));
                    counter += 0.1;
                    try {
                        Thread.sleep(500);
                    } catch (InterruptedException ex) {
                ...
                Log.i("££angka mainnya:", String.valueOf(main));
                Log.i("££angka counternya:", String.valueOf(counter));
                Log.e("££ volume dlm loop :", String.valueOf(volume));
            }
//            mySound.play(raygunID, 1, 1, 1, 0, (((float)(Math.pow(2,(volume*10/12)))/10)*4));

            Log.e("££ volume luar loop :", String.valueOf(volume));

            if (volume > 0.9){
//                mySound.play(bID, 1, 1, 1, 0, ((float)(Math.pow(2, ((((volume + (counter - 0.3)) * 10 * 3-48)/ 12))))));
                mySound.play(bID, 1, 1, 1, 0, main);

                Log.i("££counter last 9:", String.valueOf(e.getVal())+"&"+String.valueOf(2093*(Math.pow(2, ((((volume + (counter - 0.3)) * 10 * 3-48)/ 12))))));
            }
            else if (volume > 0.6){
//                mySound.play(a5ID, 1, 1, 1, 0, ((float)(Math.pow(2, ((((volume + (counter - 0.2)) * 10 * 3-33)/ 12))))));
                mySound.play(a5ID, 1, 1, 1, 0, main);
                Log.i("££counter last 6:", String.valueOf(e.getVal())+"&"+String.valueOf(880*(Math.pow(2, ((((volume + (counter - 0.2)) * 10 * 3-33)/ 12))))));
            }
            else if (volume > 0.4){
//                mySound.play(aID, 1, 1, 1, 0, ((float)(Math.pow(2, ((((volume + (counter - 0.1)) * 10 * 3-21)/ 12))))));
                mySound.play(aID, 1, 1, 1, 0, main);
                Log.i("££counter last 4:", String.valueOf(e.getVal())+"&"+String.valueOf(440*(Math.pow(2, ((((volume + (counter - 0.1)) * 10 * 3-21)/ 12))))));
            }
            else if (volume > 0.2){
//                mySound.play(eID, 1, 1, 1, 0, ((float)(Math.pow(2, (((volume + (counter - 0.1)) * 10 * 3/ 12)-1)))));
                mySound.play(eID, 1, 1, 1, 0, main);
                Log.i("££counter last 2:", String.valueOf(e.getVal())+"&"+String.valueOf(261.62*((float)(Math.pow(2, (((volume + (counter - 0.1)) * 10 * 3/ 12)-1))))));
            }
            else if (volume <= 0.2){
...
//                Log.i("££counter ulang<=2:", String.valueOf(e.getVal())+"&"+String.valueOf(130.81*((float)(Math.pow(2,(volume*20* 3/12))))));
                Log.i("££counter ulang<=2:", String.valueOf(e.getVal())+"&"+String.valueOf(130.81*((float)(Math.pow(2,(volume*20* 3/12))))));
            }
        }
